...
function spacexchimp_p010_settings_link( $links ) {
    $page = '<a href="' . admin_url( 'admin.php?page=spacexchimp/' . SPACEXCHIMP_P010_SLUG ) .'">' . __( 'Settings', SPACEXCHIMP_P010_TEXT ) . '</a>';
 ...
 */
function spacexchimp_p010_register_admin_menu() {
...
add_action( 'admin_menu', 'spacexchimp_p010_register_admin_menu' );
...
function spacexchimp_p010_register_submenu_page() {
    ...
    $capability  = 'manage_options';
    $menu_slug   = 'spacexchimp/' . SPACEXCHIMP_P010_SLUG;
 ...
 */
function spacexchimp_p010_remove_submenu_item() {
...
add_action( 'admin_menu', 'spacexchimp_p010_remove_submenu_item' );
...
function spacexchimp_p010_admin_footer_text() {
    ...
    $settings_page = 'space-x-chimp_page_spacexchimp/' . SPACEXCHIMP_P010_SLUG;
