            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="<?php echo SPACEXCHIMP_P010_URL . 'inc/img/spacexchimp-logo.png'; ?>">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <p>
                            <?php _e( 'Hello!', SPACEXCHIMP_P010_TEXT ); ?>
                            <?php _e( 'We are the team of Space X-Chimp.', SPACEXCHIMP_P010_TEXT ); ?>
                        </p>
                        <p>
                            <?php
                                printf(
                                    __( 'Thank you for installing our plugin! We hope you will love it! %s', SPACEXCHIMP_P010_TEXT ),
                                    '&#x1F603;'
                                );
                            ?>
                        </p>
