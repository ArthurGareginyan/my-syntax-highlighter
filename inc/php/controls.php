 ...
 */
function spacexchimp_p010_control_help( $help=null ) {
 ...
 */
function spacexchimp_p010_control_field( $name, $label, $help=null, $placeholder=null ) {
    ...
    $out = "<tr>
                ...
                <td>
                    <input
                        type='text'
                        name='" . SPACEXCHIMP_P010_SETTINGS . "_settings[$name]'
                        id='" . SPACEXCHIMP_P010_SETTINGS . "_settings[$name]'
                        value='$value'
    ...
    // Print a help text
    spacexchimp_p010_control_help( $help );
}

/**
 * Generator of the switch option for saving plugin settings to database
 */
function spacexchimp_p010_control_switch( $name, $label, $help=null ) {
 ...
 */
function spacexchimp_p010_control_number( $name, $label, $help=null, $default=null ) {
 ...
 */
function spacexchimp_p010_control_list( $name, $items, $label, $help, $default ) {
