 ...
 * @since 2.1
 */
function mshighlighter_plugin_version_number() {
    ...
    if ( $new_number == $current_number ) {
        ...
        if ( $info['old_version'] == '1' ) {
            ...
            $info['old_version'] = '0';
            update_option( MSHIGHLIGHTER_SETTINGS . '_service_info', $info );
...
mshighlighter_plugin_version_number();
