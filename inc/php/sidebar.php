            ...
            <div class="postbox banner">
                ...
                <div class="inside">
                    <a href="https://www.spacexchimp.com/" target="_blank">
                        <img src="<?php echo SPACEXCHIMP_P010_URL . 'inc/img/spacexchimp-logo.png'; ?>" alt="Space X-Chimp">
                    </a>
                </div>
            </div>
            ...
            <div class="postbox banner">
                <div class="inside">
                    <a href="https://www.spacexchimp.com/plugins/my-syntax-highlighter-pro.html" target="_blank">
                        <img src="<?php echo SPACEXCHIMP_P010_URL . 'inc/img/upgrade.png'; ?>" alt="Upgrade" style="margin-top:-16px;">
                    </a>
                </div>
            </div>
