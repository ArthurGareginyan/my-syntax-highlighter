            ...
            <div class="tab-page fade" id="tab-faq">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="question-7 question-red"><?php _e( 'The last WordPress update is preventing me from editing my website that is using this plugin. Why is this?', MSHIGHLIGHTER_TEXT ); ?></div>
                        <div class="answer-7"><?php _e( 'This plugin can not cause such problem. More likely, the problem are related to the settings of the website. It could just be a cache, so please try to clear your website\'s cache (may be you using a caching plugin, or some web service such as the CloudFlare) and then the cache of your web browser. Also please try to re-login to the website, this too can help.', MSHIGHLIGHTER_TEXT ); ?></div>

                        <div class="question-8 question-red"><?php _e( 'Where to report bug if found?', MSHIGHLIGHTER_TEXT ); ?></div>
                        ...
                        <div class="question-9"><?php _e( 'Where to share any ideas or suggestions to make the plugin better?', MSHIGHLIGHTER_TEXT ); ?></div>
                        ...
                        <div class="question-10"><?php _e( 'I love this plugin! Can I help somehow?', MSHIGHLIGHTER_TEXT ); ?></div>
