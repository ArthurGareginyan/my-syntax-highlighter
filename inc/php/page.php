...
function mshighlighter_render_submenu_page() {
    ...
    $name = MSHIGHLIGHTER_NAME;
    $slug = MSHIGHLIGHTER_SLUG;
    $version = MSHIGHLIGHTER_VERSION;
    $text = MSHIGHLIGHTER_TEXT;
    ...
    <div class="wrap">
        ...
        <div id="poststuff" class="metabox-holder has-right-sidebar">
            ...
            <div class="tab-page fade active in" id="tab-core">
                <!-- INCLUDE SIDEBAR -->
                <?php require_once( MSHIGHLIGHTER_PATH . 'inc/php/sidebar.php' ); ?>
                <!-- INCLUDE SETTINGS -->
...
[/code]</code></pre>
            ...
            <div class="tab-page fade" id="tab-support">
                <div class="postbox">
                    ...
                    <div class="inside">
                        <img src="<?php echo MSHIGHLIGHTER_URL . 'inc/img/thanks.png'; ?>" alt="Thanks!" class="pull-right">
